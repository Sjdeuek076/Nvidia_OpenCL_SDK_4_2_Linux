...
int main(int argc, char** argv) {
	...
	NR::powell(starting_point, identity_matrix, ftol, iter, fret, minimize_target_particle_unscented_kalman_parameters_1_dim);
...
DP minimize_target_particle_unscented_kalman_parameters_1_dim(Vec_I_DP & input) {
	...
	estimate_particle_unscented_kalman_parameters_1_dim(log_stock_prices,
		muS,
		n_stock_prices,
		omega,
		theta,
